...
const Dashboard = memo(() => {
    ...
    //     try {
    //         const temperatureResponse = await deviceService.getLatestValue(
    //             'temperature,humidity',
    //             DEVICE_ID.DHT22
    //         );
    //         const oxygenResponse = await deviceService.getLatestValue(
    //             'oxygen',
    //             DEVICE_ID.OXYGEN
    //         );
    ...
    //             temperature: {
    //                 value: formatNumber(
    //                     temperatureResponse?.temperature?.[0]?.value ||
    //                         deviceData.temperature.value
    //                 ),
    //                 ts:
    //                     temperatureResponse?.temperature?.[0]?.ts ||
    //                     deviceData.temperature.ts,
    //             },
    //             humidity: {
    //                 value: formatNumber(
    //                     temperatureResponse?.humidity?.[0]?.value ||
    //                         deviceData.humidity.value
    //                 ),
    //                 ts:
    //                     temperatureResponse?.humidity?.[0]?.ts ||
    //                     deviceData.humidity.ts,
    //             },
    //             oxygen: {
    //                 value: formatNumber(
    //                     oxygenResponse?.oxygen?.[0]?.value ||
    //                         deviceData.oxygen.value
    //                 ),
    ...
    //         setLightStatus(
    //             formatBoolean(lightStatusResponse?.status?.[0]?.value)
    //         );
    //     } catch (error) {
    //         setDeviceData({
    //             temperature: { value: -1, ts: Date.now() },
